...
function theme.at_screen_connect(s)
	...
	-- Main dispaly tag configuration
	if s.index==1 then
		awful.tag.add("1", {
	...
	-- Second display tag configuration
	if s.index==2 then
	for m = 8, 9 do
		awful.tag.add(m, {
			layout             = awful.layout.layouts[1],
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
			...
			-- 792FFF
			net_wired,
            arrow(theme.bg_normal, "#AD0018"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net_wireless, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#AD0018"),
            arrow("#AD0018", "#792FFF"),
            wibox.container.background(wibox.container.margin(wibox.widget { volume_widget(), layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#792FFF"),
            arrow("#792FFF", "#7600AD"),
            wibox.container.background(wibox.container.margin(wibox.widget { brightness_widget{type = 'icon_and_text', program = 'brightnessctl', step = 2,}, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#7600AD"),
			arrow("#7600AD","#FF6800"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#FF6800"),
            arrow("#FF6800", "#009C9F"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#009C9F"),
            arrow("#009C9F", "#FF0034"),
            wibox.container.background(wibox.container.margin(wibox.widget { clock, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#FF0034"),
            arrow("#FF0034", "alpha"),
            --]]
            s.mylayoutbox,
        },
