...
globalkeys = mytable.join(
    ...
    awful.key({ altkey,           }, "Tab", function () awful.layout.inc( 1)                end,
	...
	awful.key({ modkey, "Shift" }, "h", function () awful.util.spawn("flameshot gui") end),
...
-- Function that returns screen count
screen_count = function() return screen.count() end
...
awful.rules.rules = {
	...
	{ rule = { class = "Google-chrome" },properties = { tag = "2" } },
	{ rule = { class = "TelegramDesktop" },properties = { tag = "8" } },
	{ rule = { class = "Slack" },properties = { tag = "1" } },
	{ rule = { class = "Code" },properties = { tag = "5" } },
	{ rule = { class = "obsidian" },properties = { tag = "6" } },
	{ rule = { class = "Brave-browser" },properties = { tag = "9" }},
...
awful.spawn.once("gnome-terminal", {tag="3"})
awful.spawn.once("code /opt")
